...
// gán số sp hiển thị trên trang
$rows_per_page = 5;
// công thức ính toán chỉ số key
				...
				<div class="panel panel-default">
					<div class="panel-body">
                        <table 
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM product INNER JOIN category ON product.cat_id =category.cat_id ORDER BY prd_id ASC LIMIT $per_rows, $rows_per_page";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><span class="label 
                                        <?php if($row['prd_status']){echo 'label-success';}else{ echo 'label-danger';} ?>">
                                        <?php if($row['prd_status']){echo'Còn hàng';}else{ echo 'Hết hàng';} ?> </span></td>
