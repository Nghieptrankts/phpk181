...
$sql = "SELECT * FROM roduct WHERE prd_id";
$query = mysqli_query($connect, $sql);
$row = mysqli_fetch_assoc($query);
// lấy ra danh mục
$sql_cat = "SELECT * FROM category ORDER BY cat_name ASC;
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <img src="img/product/<?php echo $row['prd_image']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php while($row_cat = mysqli_fetch_assoc($query_cat)){ ?>
                                        <option <?php if($row['cat_id'] == $row_cat['cat_id']){echo 'selected'} ?> value=1>iPhone</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input <?php if($row['prd_featured']==1){echo 'checker';} ?> name="prd_featured" type="checkbox" value=1>Nổi bật
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
